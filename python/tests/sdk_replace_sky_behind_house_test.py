from decor8ai.client import replace_sky_behind_house
import os
import base64
import requests

# Mandatory Parameters
input_image_url = 'https://prod-files.decor8.ai/test-images/sdk_replace_sky_test_image.png'

response_json = replace_sky_behind_house(input_image_url=input_image_url, sky_type='day')
